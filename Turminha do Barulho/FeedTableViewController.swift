...
class FeedTableViewController: UITableViewController, UISearchControllerDelegate, UISearchBarDelegate, CustomSearchControllerDelegate {
    ...
    func createData()
    {
        self.data.append(Dados(titulo: "Jornal na guerra", subtitulo: "Jornalismo", texto: "Saiba mais sobre os jornalistas que cobriram de perto algumas guerras", imagem: UIImage(named: "Jtest"),upvote: 1042,fulltext:jornalismo))
